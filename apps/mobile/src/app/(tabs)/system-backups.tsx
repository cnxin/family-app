...
const styles = StyleSheet.create({
  ...
  smallButton: { minHeight: 44, borderRadius: radius.sm, paddingHorizontal: 11, alignItems: 'center', justifyContent: 'center' },
  ...
  dayButton: { width: 44, height: 44, borderRadius: radius.sm, alignItems: 'center', justifyContent: 'center' },
  ...
  squareButton: { width: 44, height: 44, borderRadius: radius.sm, alignItems: 'center', justifyContent: 'center' },
});
