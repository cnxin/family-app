...
const styles = StyleSheet.create({
  ...
  anonymizeAction: { minHeight: 30, alignSelf: 'flex-start', borderRadius: radius.sm, paddingHorizontal: 8, justifyContent: 'center', marginTop: 9 },
