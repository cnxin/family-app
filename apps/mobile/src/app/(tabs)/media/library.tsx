...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, minWidth: 0, height: 40, outlineStyle: 'none' } as never,
  ...
  actions: { minHeight: 51, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: 'row', padding: 7, gap: 7 },
  actionButton: { flex: 1, minHeight: 37, borderRadius: radius.sm, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  disabled: { opacity: 0.42 },
  pagination: { marginTop: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 16 },
  pageButton: { width: 40, height: 40, borderRadius: radius.sm, alignItems: 'center', justifyContent: 'center' },
