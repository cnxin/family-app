...
面向家庭成员的生活协作平台。当前已完成点菜、菜单、菜谱、采购库存闭环、统一日历、家庭任务、积分奖励、家庭财务、投票、提醒、观影片单、三源搜索、MoviePilot/Plex/Emby 集成、独立访客流程、家庭资产与维护、知识库、出行清单和备份运维。
...
- **家庭财务**：维护家庭共享账户、收入、支出、账户间转账和月度分类预算；交易与过账不可修改，误记通过反向流水撤销；Hermes 可查询汇总并生成需成员确认的单笔记账提案。
...
- 儿童、健康、宠物和多家庭切换等敏感模块等待真实需求，不提前建设空能力
