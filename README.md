...
面向家庭成员的生活协作平台。当前已完成点菜、菜单、菜谱、采购库存闭环、统一日历、家庭任务、投票、提醒、观影片单、三源搜索、MoviePilot/Plex/Emby 集成、独立访客流程，以及家庭资产与维护。

> 当前可用流程：家人安排菜单、来访、观影、维护和周期任务 -> 发起家庭决策并投票 -> 设置多人提醒 -> 协作备餐并生成采购差额 -> 明确确认入库或扣库 -> 在日历、通知、库存流水和家庭活动中追踪结果
...
- **统一日历**：按月聚合菜单、家庭事件、任务、观影排期、访客来访与资产维护；支持事件管理和来源模块跳转。
...
- **可配置提醒**：为菜单、任务、家庭事件、投票和资产维护设置精确时间及多个接收人；支持编辑、取消、来源跳转和失效自动取消。
- **通知中心**：汇总菜单、任务、投票、提醒、媒体和访客等模块通知，支持逐条或全部标记已读，并在桌面与移动端显示未读入口。
...
- **家庭资产**：记录家电、家具和设备档案、购买保修资料与维护周期；维护进入日历、提醒和活动审计，本地附件使用家庭鉴权和短时签名访问。
...
# 家庭隔离、统一日历、周期任务、通用通知、家庭投票、可配置提醒、多人菜谱、菜单做法快照、采购库存流水、资产维护、安全附件、菜单协作、审计、健康检查、请求日志、敏感信息保护、
# 唯一约束和事务回滚，结束后自动清理
...
- [ ] M6：库存采购闭环与家庭资产已完成；积分、耗材联动、外部通知和运维能力待实施
- [ ] M7：仅按真实需求评估儿童、健康、财务、宠物或多家庭等敏感模块
