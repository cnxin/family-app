...
面向家庭成员的生活协作平台。当前已完成点菜、菜单、菜谱、采购库存闭环、统一日历、家庭任务、积分奖励、投票、提醒、观影片单、三源搜索、MoviePilot/Plex/Emby 集成、独立访客流程，以及家庭资产与维护。

> 当前可用流程：家人安排菜单、来访、观影、维护和周期任务 -> 完成任务获得积分并申请家庭奖励 -> 发起家庭决策并投票 -> 设置多人提醒 -> 协作备餐并生成采购差额 -> 明确确认入库或扣库 -> 在日历、通知、不可变流水和家庭活动中追踪结果
...
- [ ] M6：库存采购闭环、家庭资产和积分奖励已完成；耗材联动、外部通知和运维能力待实施
