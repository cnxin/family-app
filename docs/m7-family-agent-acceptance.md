...
> 实施分支：`uitest`
> 范围：M7-A4.1 只读 Agent 基础、M7-A4.2 App 内“问问小管家”与 M7-A4.3 操作提案确认
...
M7-A4.4 再增加消息渠道配对与只读使用；M7-A4.5 完成 Hermes 生产容器网络和出口加固。长期主动任务、访客采纳、敏感生活数据和没有明确撤销契约的自动撤销仍不在本批范围。
