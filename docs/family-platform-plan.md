...
> 文档状态：总体方向已确认，按阶段实施
> 更新日期：2026-07-30
> 当前版本：点菜、多人厨房协作、菜谱、采购库存、家庭公共能力与连接器无关的家庭观影片单已进入本地 Web 演示阶段
...
前端质量门禁可以通过 `corepack pnpm lint`、`corepack pnpm typecheck` 和 `corepack pnpm test:web` 重复执行。M2、M3 已冻结，M4-A 连接器无关的家庭片单、状态、排期、统一日历和活动记录已经完成。下一次实施范围：
