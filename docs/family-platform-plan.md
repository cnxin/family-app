...
> 文档状态：总体方向已确认，按阶段实施
> 更新日期：2026-08-03
> 当前版本：点菜、多人厨房协作、菜谱、采购库存流水、家庭资产维护、积分奖励、外部通知、备份运维、家庭知识库、家庭出行、家庭回忆、今日家庭助理、统一日历、活动审计、安全附件、家庭观影与访客协作已进入本地 Web 演示阶段
...
1. 待中兴设备型号确认后评估只读网络连接器；真实 NAS Webhook 联调作为部署验收，不把密钥写入代码或文档。
2. M7 下一批优先观察家庭回忆与今日助理的真实使用频率，再评估纪念日、共享相册整理或智能家居连接；不提前增加健康、财务或儿童敏感数据。
