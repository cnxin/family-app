...
前端质量门禁可以通过 `corepack pnpm lint`、`corepack pnpm typecheck` 和 Expo Web 导出重复执行。M2、M3 已冻结，M4 的观影流程和 M5 的访客流程已经完成；M6-A1/A2 已交付库存采购闭环，M6-A3/A5 已交付家庭资产、维护周期、耗材库存采购、统一日历、活动审计与安全附件，M6-A4 已交付积分流水、任务积分、家庭奖励与兑换状态机，M6-A6 已交付外部通知渠道、成员偏好、投递历史与失败重试，M6-A7 已交付备份计划、保留策略、容量告警和隔离恢复演练，M7-A1 已交付家庭知识库与不可变版本历史，M7-A2 已交付非敏感家庭出行计划、协作清单和打包模板，M7-A3 已交付非敏感家庭回忆、私有照片和今日家庭助理，M7-A4.1/A4.2 已交付只读 Family MCP、Hermes 可选运行时与 App 内问问小管家。当前共有 44 个有序迁移，详见 [M7 家庭智能体首批验收](m7-family-agent-acceptance.md)。下一次实施范围：

1. M7-A4.3 增加任务、提醒、投票、菜单和购物的结构化操作提案；所有写入先显示预计变化并由用户确认。
