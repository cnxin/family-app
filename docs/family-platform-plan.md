...
> 文档状态：总体方向已确认，按阶段实施
> 更新日期：2026-08-03
> 当前版本：点菜、多人厨房协作、菜谱、采购库存流水、家庭资产维护、积分奖励、外部通知、备份运维、家庭知识库、家庭出行、家庭回忆、今日家庭助理、统一日历、活动审计、安全附件、家庭观影与访客协作已进入本地 Web 演示阶段；家庭智能体与下一批生活能力已完成方案设计
...
| 家庭智能体 | 方案已确认，待实施 | Hermes 可替换运行时、只读 MCP、操作提案、用户确认、审计与故障降级 |
...
- [ ] Hermes 独立运行时、只读家庭 MCP 与 App 内“问问小管家”。
- [ ] 任务、提醒、投票、菜单和购物的 Agent 操作提案与明确确认。
- [ ] 纪念日、共享相册和“往年今天”。
- [ ] 食品批次、保质期、临期提醒和智能菜单候选。
- [ ] 访客点菜采纳、家庭周报和知识库附件。
...
前端质量门禁可以通过 `corepack pnpm lint`、`corepack pnpm typecheck` 和 Expo Web 导出重复执行。M2、M3 已冻结，M4 的观影流程和 M5 的访客流程已经完成；M6-A1/A2 已交付库存采购闭环，M6-A3/A5 已交付家庭资产、维护周期、耗材库存采购、统一日历、活动审计与安全附件，M6-A4 已交付积分流水、任务积分、家庭奖励与兑换状态机，M6-A6 已交付外部通知渠道、成员偏好、投递历史与失败重试，M6-A7 已交付备份计划、保留策略、容量告警和隔离恢复演练，M7-A1 已交付家庭知识库与不可变版本历史，M7-A2 已交付非敏感家庭出行计划、协作清单和打包模板，M7-A3 已交付非敏感家庭回忆、私有照片和今日家庭助理。当前共有 43 个有序迁移，详见 [M6 库存与采购闭环验收](m6-inventory-shopping-acceptance.md)、[M6 家庭资产与维护验收](m6-assets-maintenance-acceptance.md)、[M6 积分与奖励验收](m6-points-rewards-acceptance.md)、[M6 外部通知渠道与投递验收](m6-external-notifications-acceptance.md)、[M6 备份运维验收](m6-backup-operations-acceptance.md)、[M7 家庭知识库验收](m7-household-knowledge-acceptance.md)、[M7 家庭出行验收](m7-household-travel-acceptance.md) 与 [M7 家庭回忆验收](m7-family-memories-acceptance.md)。下一次实施范围：

1. M7-A4.1 优先建立 `AgentRuntime`、Hermes 独立容器、Fake Runtime、短时成员委托和只读 Family MCP；Hermes 不接触数据库、Docker、上传卷、备份目录或 NAS 密钥。
2. M7-A4.2 增加 App 内“问问小管家”和管理员运行时设置，保留现有确定性今日助理作为离线降级。
3. M7-A4.3 增加任务、提醒、投票、菜单和购物的结构化操作提案；所有写入先显示预计变化并由用户确认。
4. 后续依次实施纪念日与共享相册、食品批次与智能菜单、访客采纳与家庭周报、知识库附件，再评估消息渠道、PWA 离线和 Home Assistant。
5. 待中兴设备型号确认后评估只读网络连接器；真实 NAS Webhook 和 Hermes 模型/消息渠道联调作为部署验收，不把密钥写入代码或文档。

家庭智能体及上述未完成能力的完整拆分和验收标准见 [M7-A4 家庭智能体与后续能力实施方案](m7-family-agent-roadmap.md)。不提前增加健康、财务或儿童敏感数据。
