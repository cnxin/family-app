...
前端质量门禁可以通过 `corepack pnpm lint`、`corepack pnpm typecheck` 和 Expo Web 导出重复执行。M2、M3 已冻结，M4 的观影流程和 M5 的访客流程已经完成；M6-A1/A2 已交付库存采购闭环，M6-A3/A5 已交付家庭资产、维护周期、耗材库存采购、统一日历、活动审计与安全附件，M6-A4 已交付积分流水、任务积分、家庭奖励与兑换状态机，M6-A6 已交付外部通知渠道、成员偏好、投递历史与失败重试，M6-A7 已交付备份计划、保留策略、容量告警和隔离恢复演练，M7-A1 已交付家庭知识库与不可变版本历史，M7-A2 已交付非敏感家庭出行计划、协作清单和打包模板，M7-A3 已交付非敏感家庭回忆、私有照片和今日家庭工作台，M7-A4.1 至 A4.6 已交付受控家庭智能体能力，M7-A5.2 已交付食品批次、临期状态、FIFO 扣库预览和可解释智能菜单；普通成员首页已进一步精简为默认行动视图，次要内容通过点击展开。当前共有 51 个有序迁移，详见 [M7 家庭智能体首批验收](m7-family-agent-acceptance.md)、[普通成员今日工作台与家庭收件箱验收](consumer-home-inbox-acceptance.md) 和 [M7-A5.2 食品批次、保质期与智能菜单验收](m7-food-batches-smart-menu-acceptance.md)。下一次实施范围：
