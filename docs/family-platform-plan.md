...
M5-C2 已支持经明确授权的访客点菜请求。访客可按来访日期和餐次提交想吃的菜与口味备注，家庭管理员在来访页单独接受或拒绝；请求不写入家庭菜单项、不暴露菜谱或库存，也不把访客伪装为家庭成员。详细边界见 [M5-C2 访客点菜请求验收](m5-guest-meal-requests-acceptance.md)。
