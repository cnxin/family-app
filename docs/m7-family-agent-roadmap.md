...
以下内容来自前期产品讨论；M7-A5.2 已在 `uitest` 完成，其余批次仍未实现，不应因智能体接入而被遗漏。
...
- 已增加第 51 个有序迁移、不可变批次流水、家庭范围幂等与并发锁；完整验收见 [M7-A5.2 食品批次、保质期与智能菜单验收](m7-food-batches-smart-menu-acceptance.md)。
